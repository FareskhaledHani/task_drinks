...
class ColorsManager {
  ...
  static const Color watermillon = Color(0xffF89A9A);
  static const Color orange = Color(0xffF4C264);
  static const Color orangedac = Color(0xffF5835F);
  static const Color bluedac = Color(0xff472EBC);
